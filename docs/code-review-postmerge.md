...
- [ ] **CR-001** — `vulnerability` | `sunnah_toolkit/core/reranker.py:77, 130-133`
...
- [ ] **CR-002** — `bad-pattern` | `sunnah_toolkit/api/ui.py:733-798, 929-968`
...
- [ ] **CR-003** — `bad-pattern` | `sunnah_toolkit/core/tools.py:144-265, 274-281`
...
- [ ] **HI-001** — `memory-leak` | `sunnah_toolkit/core/reranker.py:168-174`
...
- [ ] **HI-002** — `performance` | `sunnah_toolkit/core/reranker.py:81-88`
...
- [ ] **HI-003** — `error-handling` | `sunnah_toolkit/core/tools.py:187-198`
...
- [ ] **HI-004** — `concurrency` | `sunnah_toolkit/core/semantic.py:98-119`
...
- [ ] **HI-005** — `bad-pattern` | `sunnah_toolkit/core/tools.py:200-218`
...
- [ ] **HI-006** — `test-gap` | `sunnah_toolkit/core/tools.py:144-265`
...
- [ ] **ME-001** — `bad-pattern` | `sunnah_toolkit/core/data.py:399, 428`
...
- [ ] **ME-002** — `lengthy-function` | `sunnah_toolkit/core/tools.py:144-265`
...
- [ ] **ME-003** — `performance` | `sunnah_toolkit/core/tools.py:124-141, sunnah_toolkit/core/data.py:234-244`
...
- [ ] **ME-004** — `error-handling` | `sunnah_toolkit/api/app.py:27-40`
...
- [ ] **ME-005** — `concurrency` | `sunnah_toolkit/core/retrieval.py:92-98`
...
- [ ] **ME-006** — `test-gap` | `sunnah_toolkit/core/retrieval.py`
...
- [ ] **ME-007** — `bad-pattern` | `sunnah_toolkit/core/tools.py:218, 261`
...
- [ ] **ME-008** — `vulnerability` | `sunnah_toolkit/api/app.py:60-65`
...
- [ ] **ME-009** — `bad-pattern` | `sunnah_toolkit/core/tools.py:194-198`
...
- [ ] **ME-010** — `performance` | `sunnah_toolkit/api/ui.py:624-657`
...
- [ ] **LO-001** — `style` | `sunnah_toolkit/core/reranker.py:38-45, sunnah_toolkit/core/semantic.py:36-43`
...
- [ ] **LO-002** — `naming` | `sunnah_toolkit/core/retrieval.py:38-45`
...
- [ ] **LO-003** — `dead-code` | `pyproject.toml:23-26`
...
- [ ] **LO-004** — `naming` | `sunnah_toolkit/core/tools.py:144`
...
- [ ] **LO-005** — `doc-gap` | `sunnah_toolkit/core/reranker.py:11-13`
...
- [ ] **LO-006** — `unnecessary` | `sunnah_toolkit/core/data.py:391`
...
- [ ] **LO-007** — `bad-pattern` | `sunnah_toolkit/core/tools.py:241-242`
...
- [ ] **LO-008** — `naming` | `sunnah_toolkit/core/tools.py:272, 304, 342`
...
- [ ] **LO-009** — `performance` | `scripts/build_models.py:55`
...
- [ ] **LO-010** — `coupling` | `sunnah_toolkit/core/tools.py:131`
...
- [ ] **LO-011** — `test-gap` | `tests/test_retrieval_latency.py:37-54`
...
- [ ] **LO-012** — `style` | `sunnah_toolkit/core/tools.py:218`
